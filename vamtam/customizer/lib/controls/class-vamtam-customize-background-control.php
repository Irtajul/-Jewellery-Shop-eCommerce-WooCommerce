...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'bijoux' ),
			'change'       => esc_html__( 'Change Image', 'bijoux' ),
			'remove'       => esc_html__( 'Remove', 'bijoux' ),
			'default'      => esc_html__( 'Default', 'bijoux' ),
			'placeholder'  => esc_html__( 'No image selected', 'bijoux' ),
			'frame_title'  => esc_html__( 'Select Image', 'bijoux' ),
			'frame_button' => esc_html__( 'Choose Image', 'bijoux' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'bijoux' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'bijoux' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'bijoux' ),
				'repeat'    => esc_html__( 'Repeat both', 'bijoux' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'bijoux' ),
				'fixed'  => esc_html__( 'fixed', 'bijoux' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'bijoux' ),
				'cover'   => esc_html__( 'cover', 'bijoux' ),
				'contain' => esc_html__( 'contain', 'bijoux' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'bijoux' ),
				'left center'   => esc_html__( 'left center', 'bijoux' ),
				'left bottom'   => esc_html__( 'left bottom', 'bijoux' ),
				'center top'    => esc_html__( 'center top', 'bijoux' ),
				'center center' => esc_html__( 'center center', 'bijoux' ),
				'center bottom' => esc_html__( 'center bottom', 'bijoux' ),
				'right top'     => esc_html__( 'right top', 'bijoux' ),
				'right center'  => esc_html__( 'right center', 'bijoux' ),
				'right bottom'  => esc_html__( 'right bottom', 'bijoux' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'bijoux' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'bijoux' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'bijoux' ),
			'background-repeat'     => esc_html__( 'Repeat', 'bijoux' ),
			'background-image'      => esc_html__( 'Image', 'bijoux' ),
			'background-attachment' => esc_html__( 'Attachment', 'bijoux' ),
			'background-size'       => esc_html__( 'Size', 'bijoux' ),
			'background-position'   => esc_html__( 'Position', 'bijoux' ),
			'background-color'      => esc_html__( 'Color', 'bijoux' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'bijoux' ),
				'color-2'              => esc_html__( 'Color 2', 'bijoux' ),
				'location'             => esc_html__( 'Location', 'bijoux' ),
				'type'                 => esc_html__( 'Type', 'bijoux' ),
				'position'             => esc_html__( 'Position', 'bijoux' ),
				'angle'                => esc_html__( 'Angle', 'bijoux' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'bijoux' ),
					'radial' => esc_html__( 'Radial', 'bijoux' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'bijoux' ),
					'center left'   =>  esc_html__( 'Center Left' , 'bijoux' ),
					'center right'  =>  esc_html__( 'Center Right' , 'bijoux' ),
					'top center'    =>  esc_html__( 'Top Center' , 'bijoux' ),
					'top left'      =>  esc_html__( 'Top Left' , 'bijoux' ),
					'top right'     =>  esc_html__( 'Top Right' , 'bijoux' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'bijoux' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'bijoux' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'bijoux' ),
				],
			],
		);
