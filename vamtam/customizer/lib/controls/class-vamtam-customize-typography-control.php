...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'bijoux' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'bijoux' ),
			'font-weight'                     => esc_html__( 'Weight', 'bijoux' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'bijoux' ),
				'uppercase'    => esc_html__( 'Uppercase', 'bijoux' ),
				'lowercase'    => esc_html__( 'Lowercase', 'bijoux' ),
				'capitalize'   => esc_html__( 'Capitalize', 'bijoux' ),
				'normal'       => esc_html__( 'Normal', 'bijoux' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'bijoux' ),
				'normal'       => esc_html__( 'Normal', 'bijoux' ),
				'italic'       => esc_html__( 'Italic', 'bijoux' ),
				'oblique'      => esc_html__( 'Oblique', 'bijoux' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'bijoux' ),
				'underline'    => esc_html__( 'Underline', 'bijoux' ),
				'overline'     => esc_html__( 'Overline', 'bijoux' ),
				'line-through' => esc_html__( 'Line Through', 'bijoux' ),
				'none'         => esc_html__( 'None', 'bijoux' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'bijoux' ),
			'line-height'                => esc_html__( 'Line Height', 'bijoux' ),
			'color'                      => esc_html__( 'Font Color', 'bijoux' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'bijoux' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'bijoux' ), [ 'code' => [] ] ),
		);
	}
	/**
